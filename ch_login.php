<html>
    <head>
    <title>Log In | Community Management System</title>        
...
<center><h3>An Awesome Place to Meetup With Community !!</h3></center>
<center>
<div class="large-3 large-centered columns">
  ...
  <div class="large-12 columns">
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        <img src="img/loginicon.png" style="hight:80px; width:80px"><br><br>
    ...
    $password = $_POST["password"];
		$sql = "SELECT * FROM community_head where emailid = '$emailid' and password = '$password' ";
        ...
        {
            session_start();
            $_SESSION['ch_email']=$email;
            header("Location: communityheadprofile.php");
        }
        else
        {
